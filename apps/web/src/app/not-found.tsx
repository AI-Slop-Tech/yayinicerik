...
export default function NotFound() {
  return (
    <div className="container-x flex min-h-[60vh] flex-col items-center justify-center text-center">
      ...
      <h1 className="mt-2 font-display text-4xl font-bold tracking-tight">Bu sahne kesilmiş.</h1>
      <p className="mt-3 max-w-sm text-ink-soft">Aradığın sayfa yok ya da odanın süresi dolmuş olabilir.</p>
